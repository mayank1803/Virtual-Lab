...
//------------------------------------------------- Table Creation -----------------------------------------------//
function tabled() {
    rse = document.getElementById("res").value;
    rle = document.getElementById("resl").value;
    vnl = parseInt(rse) + parseInt(rle);
    vfl = parseInt(rle);
    vr = (parseInt(vnl) - parseInt(vfl)) / parseInt(vnl);
    vre = parseFloat(vr) * 100;
    table = document.getElementById("mytable");
    arr[0] = tabrowindex + 1;
    arr[1] = document.getElementById("resl").value;
    ...
    //    }
        ...
        document.getElementById("resl").style.borderColor = "";
        document.getElementById("zenrv").style.borderColor = "";
        document.getElementById("demo").innerHTML = "";

        document.getElementById("vin").value = document.getElementById("dc").value;
